...
import {
  ColorSwatchMistWhiteSole,
  NavyNightWhiteSole,
  JetBlackWhiteSole,
  JetBlackBlackSole,
  KaikuraWhiteWhiteSole,
  CharcoalCharcoalSole,
  ChalkWhiteSole,
  ChomonixDarkGreySole,
  HarvestWhiteSole,
  BoughTaupeSole,
  BlueRidgeWhiteSole,
  HeatheredBlackSunnyGoldSole,
  SolWhiteSole,
  LilacWhiteSole,
} from "./colorSwatches";
...
export default function ProductInfo({ productItems }) {
  ...
  return (
    <ProductInfoWrapper>
      ...
      <p>
        or 4 interest-free installments of $24.50 by{" "}
        <span>
          <StyledAfterpayLogo
            src={AfterpayLogo}
            alt="afterpay logo"
      ...
      <div>
        <p>
          Also available in{" "}
          <UnderLinedLink to={""}>Women's Sizes</UnderLinedLink>
        </p>
      </div>
      ...
      <div>
        <p>
          ...
          <UnderLinedLink to={""}>See Size Chart</UnderLinedLink>
        </p>
      </div>
    </ProductInfoWrapper>
  );
